...
<div class="column">
<div class="row">
	<h5 class="mx-3" style="color: black">Login Now</h5>
</div>
	<div class="col-md-12">
        ...
        @endif
			...
			<input type="submit" name="submit" value="LOGIN NOW" style="border-radius: 0%;background-color: lawngreen;color: black;border:none" class="font-weight-bold form-control">
		</form>
	</div>
</div>
</div>
...
<div class="row">
		<p class="mx-2">Not loggedin - <a class="text-dark" style="text-decoration: underline;" href="{{url('register')}}">Join Now</a><span> or </span><a style="text-decoration: underline;color: lawngreen" href="{{url('login')}}">Log in</a></p>
	</div>
