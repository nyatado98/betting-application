                ...
                @foreach ($games as $game)
                    ...
                    <div class="row" style="margin-top: -15px">
                        <div class="column col-md-12">
                            <a href="{{ url('event/id/' . $game['game_id']) }}" style="text-decoration: none;"
                    ...
                    <div class="row"
                        ...
                        <form action="{{ url('add/' . $game->id) }}" class="mb-2" id="gamesForm" method="get">
                            ...
                            <!-- </div> -->
                            <!-- <div class="col-md-3"> -->
                            <input type="submit" name="draw" value="X        <?php echo $game->draw_odds; ?>" id="second"
                                onclick="color()" class="box  font-weight-bold">
                            <!-- </div> -->
                            <!-- <div class="col-md-3"> -->
                            <input type="submit" name="two" value="2         <?php echo $game->two_odds; ?>"
                                id="third" onclick="change()"class="box font-weight-bold">
                            <!-- <div class="col-md-2"> -->
                            <input type="submit" name="more" value="+20" class="box  font-weight-bold"
                    ...
                    <div class="row"style="border-bottom: .1px solid grey;">
                        <div class="col-md-1 " style="background-color:">
                            ...
                            <form action={{url('remove')}} method='POST'>
                                ...
                                <a href="{{url('remove')}}"><button type="submit" class="btn btn-danger mt-2 mb-2">X</button></a>
                            </form>
                        </div>
