...
<div class="container col-md-6 bg-dark sticky-top">
	<div class="row mx-auto">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="column">
							...
							<hr>
							<a href="{{url('virtual')}}" class="" style="color: lawngreen">VIRTUAL SPORTS</a>
							<hr>
		...
		<a href="{{url('virtual')}}" class=" font-weight-bold mb-4 mt-4" style="color: lawngreen">VIRTUAL</a>&nbsp&nbsp&nbsp
		<a href="{{url('jackpot')}}" class="text-white font-weight-bold mb-4 mt-4">JACKPOT</a>&nbsp&nbsp&nbsp
