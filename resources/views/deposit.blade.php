...
<!-- <div class="account"> -->
	<!-- <div class="row"> -->
	<a href="{{url('deposit')}}" class="row mx-auto" style="text-decoration: none;"><a style="font-size: 13px;margin-right: 5px" class="text-white mt-3 ">@if(session('user'))
			@foreach(session('user') as $id)
			KSH {{$id['account']}}
			@endforeach
			@endif</a>
	<a href="" name="deposit" class="btn btn-success mt-2 mb-5" style="color:black;font-weight: bold;background-color: lawngreen;font-size: 12px;border-radius: 0%">DEPOSIT</a></a>
<!-- </div> -->
</div>
...
<div class="column">
	<div class="row text-center" style="border-bottom: .1px solid gray;background-color: grey">
		...
		<a href="" class="font-weight-bold mb-3 mt-3 text-center mx-5" style="color: lawngreen">Online Deposit</a>
...
<div class="">
	<p>Easily deposit money on betpawa using M-pesa Mobile. Simply enter the amount you wish to deposit below.</p>
	</div>
	...
	<div class="col-md-12">
		...
		<form method="get" action="{{url('credit_account')}}">
			<input type="number" name="account" class="form-control <?php echo ($errors->has('account')) ? 'border border-danger' : ''; ?>" style="border-radius: 0%">
		<!-- </div> -->
        ...
        @endif
			...
			<input type="submit" name="submit" value="DEPOSIT" style="border-radius: 0%;background-color: lawngreen;color: black;border:none" class="font-weight-bold form-control">
		</form>
	</div>
	<div class="col-md-12">
		<p><span class="" style="color: black;font-weight: bold;">What happen next?</span> Confirm the deposit request to Gaming international on your phone to complete the deposit.</p>
	</div>
</div>
</div>
...
?>
 <div class="col-md-12">
           ...
           <input type="number" id="num" name="amount" onkeyup="Update()" class="form-control" placeholder="Amount ....1000">
        ...
        @endif
           ...
           <div class="row">
	         <div class="col-md-12">
	         	@if(session()->has('mssg'))
            <p class="text-danger" style="color: ;font-weight: bold">{{session()->get('mssg')}}</p>
            <?php 
            echo $amount;?>
                @endif
	           <?php
